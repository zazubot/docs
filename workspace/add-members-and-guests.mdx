...
There are several ways users can interact with a zazubot workspace:

- Admins: admins who can manage workspace settings, delete a workspace, and manage other admins, members, and guests.

- Members: People on your team who can create and edit zazubots, but not edit settings or add members.

- Guests: People external to your team who you want to work with on specific zazubots. They can be invited to individual zazubots, but not an entire workspace. They can't be given workspace-wide access. They must be invited to individual zazubots to view them.
...
You will see the guests list and who has access to this particular zazubot.
