...
- "Close ZazuBot to new responses": close your ZazuBot and your users will see the following message: "This bot is now closed."
- "Unpublish typebot": mark the ZazuBot as unpublished and your users will see the following message: "The bot you're looking for doesn't exist"
