...
Variables are placeholders for content that you can then use anywhere in the zazubot. It's a very important concept to understand to truly create a customized experience for the user.
...
Let's say my zazubot contains these variables:
