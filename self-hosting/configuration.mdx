...
| NEXT_PUBLIC_ONBOARDING_TYPEBOT_ID                                 |         | ZazuBot ID used for the onboarding. Onboarding page is skipped if not provided.                                                                                                                                           |
...
| NEXT_PUBLIC_SMTP_FROM |           | From name and email (i.e. `'ZazuBot Notifications' <notifications@host.com>`)                                                                                                                                                                              |
...
Used for authenticating with GitHub. By default, it uses the credentials of a ZazuBot-dev app.
...
| S3_BUCKET               | ZazuBot | Name of the bucket where assets will be uploaded in.                               |
...
| NEXT_PUBLIC_TOLGEE_API_URL | https://tolgee.server.ahmedkhaled4d.com | The Tolgee API base URL |
...
In ZazuBot, Redis is optional and is used to:
...
The related environment variables are listed here but you are probably not interested in these if you self-host ZazuBot.
