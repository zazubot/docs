...
This lists all the breaking changes introduced in each version of ZazuBot.
...
The license was changed from AGPLv3 to FSL. It means that you can't fork the project to commercialize a ZazuBot competitor anymore. See the new requirements [here](./get-started).

### Migrated from pnpm to bun

ZazuBot is now using bun instead of pnpm as a package manager. Which means practically all deployments instructions need to be updated to now use bun.
