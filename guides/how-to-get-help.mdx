...
2. You can ask for help . Specifically in the `#help-and-questions` channel. I try to answer all the questions there daily. There is also a good chance that someone else has already asked the same question and you can find the answer there using the search bar.
...
<Note>
  I'm working on a AI-powered zazubot that will be able to answer most of the
...
Report it [here](https://hi.zazubot.com/urgent-support).
